...
class ExampleInstrumentedTest {
    ...
    fun test1() {
        ...
        Espresso.onView(withId(R.id.textViewResult))
            .check(ViewAssertions.matches(ViewMatchers.withText("Ответ: 16")))
    }
    @Test
    fun test2() {
        ...
        Thread.sleep(1500)
        Espresso.onView(withId(R.id.textViewResult))
            .check(ViewAssertions.matches(ViewMatchers.withText("Ответ: 2 x^3")))
    }
    @Test
    fun test3() {
        ...
        Thread.sleep(1500)
        Espresso.onView(withId(R.id.textViewResult))
            .check(ViewAssertions.matches(ViewMatchers.withText("Ответ: 6 x^2")))
    }
    @Test
    fun test4() {
        ...
        Thread.sleep(1500)
        Espresso.onView(withId(R.id.textViewResult))
            .check(ViewAssertions.matches(ViewMatchers.withText("Ответ: 1/2 x^4")))
    }
    @Test
    fun test5() {
        ...
        Thread.sleep(1500)
        Espresso.onView(withId(R.id.textViewResult))
            .check(ViewAssertions.matches(ViewMatchers.withText("Ответ: 2")))
    }
    @Test
    fun test6() {
        ...
        Thread.sleep(1500)
        Espresso.onView(withId(R.id.textViewResult))
            .check(ViewAssertions.matches(ViewMatchers.withText("Ответ: -1")))
    }
    @Test
    fun test7() {
        ...
        Thread.sleep(1500)
        Espresso.onView(withId(R.id.textViewResult))
            .check(ViewAssertions.matches(ViewMatchers.withText("Ответ: 0")))
    }
    @Test
    fun test8() {
    ...
    fun test9() {
        ...
        Thread.sleep(1500)
        Espresso.onView(withId(R.id.textViewResult))
            .check(ViewAssertions.matches(ViewMatchers.withText("Ответ: 1/2 pi")))
    }
    @Test
    fun test10() {
    ...
    fun test13() {
        ...
        Thread.sleep(1500)
        Espresso.onView(withId(R.id.textViewResult))
            .check(ViewAssertions.matches(ViewMatchers.withText("Ответ: 3")))
    }
    @Test
    fun test14() {
        Espresso.onView(withId(R.id.operation)).perform(ViewActions.typeText("log"))
    ...
    fun test19() {
        ...
        Thread.sleep(1500)
        Espresso.onView(withId(R.id.textViewResult))
            .check(ViewAssertions.matches(ViewMatchers.withText("Ответ: 2^2")))
    }
    @Test
    fun test20() {
        Espresso.onView(withId(R.id.operation)).perform(ViewActions.typeText("log"))
