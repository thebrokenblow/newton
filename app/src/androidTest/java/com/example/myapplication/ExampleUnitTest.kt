...
//        val test1 = newtonDao.insertAll(NewtonRoom("sin(0)"))
//        val test2 = NewtonRoom(newtonDao.getAll().result)
//        assertTrue (test1.toString() == test2.result)
//    }
//
//}
@RunWith(AndroidJUnit4::class)
class ExampleUnitTest {
    ...
    fun test1() {
        ...
        assertTrue ("sin(0)" == getResult.result)
    }
